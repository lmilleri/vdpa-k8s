...
oc exec -it -n openshift-ovn-kubernetes `./find-ovnkube-node-712.sh | awk 'FNR == 2 {print $1}'` -c ovnkube-controller -- /usr/bin/ovn-nbctl show l2.network_ovn_localnet_switch
